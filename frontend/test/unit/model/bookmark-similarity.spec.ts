...
describe('bookmark-similarity unit test', () => {
    ...
    it('from json', () => {
        const resJson = '{"bookmark": [{"id": 43, "similar_flag": false, "url": "https://paiza.jp/login"},' +
            ' {"id": 44, "similar_flag": false, "url": "http://www.nicovideo.jp/"}], "searchWord": "はい"}';
    ...
    it('json-2-way-convert', () => {
        ...
        const bookmarkSimilarity2 = JSON.parse(jsonStr) as BookmarkSimilarity;
